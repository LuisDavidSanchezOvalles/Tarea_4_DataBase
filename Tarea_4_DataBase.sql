...
values ('mision imposible','tom crusie', 128,3);
insert into peliculas(nombre,actor,duracion,cantidad)
values ('mujer bonita','julia robles', 118,3);
insert into peliculas (nombre,actor,duracion,cantidad)
...
---2do problema
 ...
 --Muestra las columnas de la tabla libros
 exec sp_columns libros;
...
--seleciona los articulos que tenga el precio mayor a 400
select * from articulos where precio >= 400;

--seleciona codigo y el nombre de los articulos menor de 30
select codigo,nombre from articulos where cantidad < 30;
--seleciona el nombre descripcion de los articulos menor y mayor de 100
...
---seleciona la duracion menor o igual 90 minutos 
select * from peliculas where duracion<=90;
--seleciona las peliculas que el actor no se tom cruise
...
telefono varchar(11)
 ...
 ---ingresa los registro de a la tabla agenda
insert into agenda (apellido,nombre,domicilio,telefono)
...
--muestra la agenda
select * from agenda;
--borra a juan de la agenda
delete from agenda where nombre='Juan';
--borra los nomero que temine asi 
delete from agenda where telefono='4545454';
--muestra la agenda
select * from agenda;
--borra la agenda
delete from agenda;
---muestra la agenda vacia
select * from agenda;
...
--Muestra la estructura de la tabla articulo
exec sp_columns articulos;

--Ingresa los registro en la tabla articulo
...
--Borra los articulos mayor y igual 500
delete from articulos where precio>=500;

--Muestra la agenda
select * from articulos;

--Borra los articulos con nombre de impresora
...
------------------------------------------------------------------------------------------------------------
--75 Funciones de Valores con tabla en Linea
